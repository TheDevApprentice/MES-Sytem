...
export const licenceData: Licence[] = [
  {
    licenceNumber: '1516171819', // Master licence
    startDate: '2022-01-01',
    endDate: '2022-12-31'
  },
  {
    licenceNumber: '15161718191233233233', // la licence user est une enfant de la master, les entreprises on un nombre de licence qu'elles achete qui leur permet de créer des utilisateur = une licence par user
    startDate: '2022-01-01',
    endDate: '2022-12-31',
...
export const userLicenceData: UserLicence[] = [
  {
    userId: 1,
    licenceNumber: '15161718191233233233'
  }
]
