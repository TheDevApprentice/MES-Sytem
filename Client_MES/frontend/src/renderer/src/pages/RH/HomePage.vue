<template>
  <div class="home-container">
    <div class="home-header">
      <div class="home-title">Tableau de bord RH</div>
    </div>
    <div class="home-content">
      <div class="home-card main-card">
        ...
        <div class="home-actions">
          <button class="home-btn">Employés</button>
          <button class="home-btn">Absences</button>
          <button class="home-btn">Recrutement</button>
          <button class="home-btn">Entretiens</button>
          <button class="home-btn">Reporting</button>
