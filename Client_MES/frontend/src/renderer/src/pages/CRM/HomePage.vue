<template>
  <div class="home-container">
    <div class="home-header">
      <div class="home-title">Tableau de bord CRM</div>
    </div>
    <div class="home-content">
      <div class="home-card main-card">
        ...
        <div class="home-actions">
          <button class="home-btn">Clients</button>
          <button class="home-btn">Opportunités</button>
          <button class="home-btn">Activités</button>
