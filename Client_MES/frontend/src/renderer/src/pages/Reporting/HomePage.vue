<template>
  <div class="home-container">
    <div class="home-header">
      <div class="home-title">Tableau de bord Reporting</div>
    </div>
    <div class="home-content">
      <div class="home-card main-card">
        ...
        <div class="home-actions">
          <button class="home-btn">Rapports MES</button>
          <button class="home-btn">Rapports ERP</button>
          <button class="home-btn">Rapports CRM</button>
          <button class="home-btn">Rapports RH</button>
          <button class="home-btn">Personnaliser</button>
        </div>
      </div>
      <div class="home-side">
