<template>
  <PageTemplateWithoutSpreadSheet :title="'🏭 Reporting'">
    <template #stats>
      <StatsCard
        title="Achats totaux"
  ...
  </PageTemplateWithoutSpreadSheet>
</template>
...
import PageTemplateWithoutSpreadSheet from './templates/PageTemplateWithoutSpreadSheet.vue'
