<template>
  <div class="home-container">
    <div class="home-header">
      <div class="home-title">Tableau de bord Test</div>
    </div>
    <div class="home-content">
      <div class="home-card main-card">
        ...
        <div class="home-actions">
          <button class="home-btn">Lancer test</button>
          <button class="home-btn">Voir résultats</button>
          <button class="home-btn">Exporter CSV</button>
          <button class="home-btn">Paramètres test</button>
        </div>
      </div>
      <div class="home-side">
