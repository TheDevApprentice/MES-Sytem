...
export class CustomMenuController extends Disposable {
  ...
  private _initCommands(): void {
    [
      ...
      this._componentManager.disposeWithMe(this._commandService.registerCommand(c))
    })
  }
  ...
  private _registerComponents(): void {
    this._componentManager.disposeWithMe(this._componentManager.register('ButtonIcon', ButtonIcon))
    this._componentManager.disposeWithMe(this._componentManager.register('ItemIcon', ItemIcon))
    this._componentManager.disposeWithMe(this._componentManager.register('MainButtonIcon', MainButtonIcon))
  }
