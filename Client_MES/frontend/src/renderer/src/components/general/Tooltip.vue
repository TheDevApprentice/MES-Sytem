  ...
  >
    ...
    >
      <div class="flex items-center gap-3 mb-2">
        ...
        <h3 class="text-sm font-semibold text-white">{{ tooltipTitle }}</h3>
      </div>
...
defineProps<{ ButtonText: string,  tooltipTitle: string, tooltipContent: string, tooltipExtra: string }>()
</script>